...
var file_proto_task_task_proto_rawDesc = []byte{
	...
	0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x06, 0x72, 0x61, 0x63, 0x6b, 0x49, 0x44, 0x22, 0xe0,
	0x0d, 0x0a, 0x0a, 0x54, 0x61, 0x73, 0x6b, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x2f, 0x0a,
	...
	0x04, 0x70, 0x6f, 0x72, 0x74, 0x32, 0xec, 0x0d, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65,
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	15, // 47: go.micro.srv.task.Query.filter:type_name -> go.micro.srv.task.TaskFilter
	17, // 48: go.micro.srv.task.LpParameter.parameter:type_name -> go.micro.srv.task.Parameter
	17, // 49: go.micro.srv.task.Parameters.parameters:type_name -> go.micro.srv.task.Parameter
	17, // 50: go.micro.srv.task.TaskInfo.parameters:type_name -> go.micro.srv.task.Parameter
	25, // 51: go.micro.srv.task.TaskInfos.tasks:type_name -> go.micro.srv.task.TaskInfo
	17, // 52: go.micro.srv.task.CallOptions.parameters:type_name -> go.micro.srv.task.Parameter
	17, // 53: go.micro.srv.task.ExecuteOptions.parameters:type_name -> go.micro.srv.task.Parameter
	7,  // 54: go.micro.srv.task.TaskService.New:input_type -> go.micro.srv.task.NewTaskReq
	10, // 55: go.micro.srv.task.TaskService.Pause:input_type -> go.micro.srv.task.TaskID
	31, // 56: go.micro.srv.task.TaskService.Cancel:input_type -> go.micro.srv.task.CancelReq
	13, // 57: go.micro.srv.task.TaskService.UpdateTask:input_type -> go.micro.srv.task.UpdateTaskReq
	8,  // 58: go.micro.srv.task.TaskService.BatchNew:input_type -> go.micro.srv.task.NewTasksReq
	11, // 59: go.micro.srv.task.TaskService.BatchCancel:input_type -> go.micro.srv.task.TaskIDs
	21, // 60: go.micro.srv.task.TaskService.SetParameters:input_type -> go.micro.srv.task.LpParameters
	22, // 61: go.micro.srv.task.TaskService.DeleteParameters:input_type -> go.micro.srv.task.LpParameterKeys
	10, // 62: go.micro.srv.task.TaskService.GetTask:input_type -> go.micro.srv.task.TaskID
	10, // 63: go.micro.srv.task.TaskService.GetHistoryTask:input_type -> go.micro.srv.task.TaskID
	16, // 64: go.micro.srv.task.TaskService.GetTasks:input_type -> go.micro.srv.task.Query
	16, // 65: go.micro.srv.task.TaskService.GetHistoryTasks:input_type -> go.micro.srv.task.Query
	27, // 66: go.micro.srv.task.TaskService.Call:input_type -> go.micro.srv.task.CallOptions
	29, // 67: go.micro.srv.task.TaskService.Execute:input_type -> go.micro.srv.task.ExecuteOptions
	5,  // 68: go.micro.srv.task.TaskService.SetGP:input_type -> go.micro.srv.task.GpParameter
	4,  // 69: go.micro.srv.task.TaskService.DelGP:input_type -> go.micro.srv.task.GPKey
	4,  // 70: go.micro.srv.task.TaskService.GetGP:input_type -> go.micro.srv.task.GPKey
	3,  // 71: go.micro.srv.task.TaskService.GetGPs:input_type -> go.micro.srv.task.GPQuery
	1,  // 72: go.micro.srv.task.TaskService.ConfigSystemGo:input_type -> go.micro.srv.task.SystemGoReq
	0,  // 73: go.micro.srv.task.TaskService.RestartSystemGo:input_type -> go.micro.srv.task.Nop
	0,  // 74: go.micro.srv.task.TaskService.GetSystemGoConfig:input_type -> go.micro.srv.task.Nop
	32, // 75: go.micro.srv.task.TaskService.Debug:input_type -> go.micro.srv.task.DebugReq
	33, // 76: go.micro.srv.task.TaskService.DebugConfig:input_type -> go.micro.srv.task.DebugConfigReq
	0,  // 77: go.micro.srv.task.TaskService.GetDebugConfig:input_type -> go.micro.srv.task.Nop
	9,  // 78: go.micro.srv.task.TaskService.New:output_type -> go.micro.srv.task.Response
	9,  // 79: go.micro.srv.task.TaskService.Pause:output_type -> go.micro.srv.task.Response
	9,  // 80: go.micro.srv.task.TaskService.Cancel:output_type -> go.micro.srv.task.Response
	9,  // 81: go.micro.srv.task.TaskService.UpdateTask:output_type -> go.micro.srv.task.Response
	9,  // 82: go.micro.srv.task.TaskService.BatchNew:output_type -> go.micro.srv.task.Response
	9,  // 83: go.micro.srv.task.TaskService.BatchCancel:output_type -> go.micro.srv.task.Response
	9,  // 84: go.micro.srv.task.TaskService.SetParameters:output_type -> go.micro.srv.task.Response
	9,  // 85: go.micro.srv.task.TaskService.DeleteParameters:output_type -> go.micro.srv.task.Response
	25, // 86: go.micro.srv.task.TaskService.GetTask:output_type -> go.micro.srv.task.TaskInfo
	25, // 87: go.micro.srv.task.TaskService.GetHistoryTask:output_type -> go.micro.srv.task.TaskInfo
	26, // 88: go.micro.srv.task.TaskService.GetTasks:output_type -> go.micro.srv.task.TaskInfos
	26, // 89: go.micro.srv.task.TaskService.GetHistoryTasks:output_type -> go.micro.srv.task.TaskInfos
	28, // 90: go.micro.srv.task.TaskService.Call:output_type -> go.micro.srv.task.CallResponse
	30, // 91: go.micro.srv.task.TaskService.Execute:output_type -> go.micro.srv.task.ExecuteResponse
	9,  // 92: go.micro.srv.task.TaskService.SetGP:output_type -> go.micro.srv.task.Response
	9,  // 93: go.micro.srv.task.TaskService.DelGP:output_type -> go.micro.srv.task.Response
	5,  // 94: go.micro.srv.task.TaskService.GetGP:output_type -> go.micro.srv.task.GpParameter
	6,  // 95: go.micro.srv.task.TaskService.GetGPs:output_type -> go.micro.srv.task.GpParameters
	9,  // 96: go.micro.srv.task.TaskService.ConfigSystemGo:output_type -> go.micro.srv.task.Response
	9,  // 97: go.micro.srv.task.TaskService.RestartSystemGo:output_type -> go.micro.srv.task.Response
	2,  // 98: go.micro.srv.task.TaskService.GetSystemGoConfig:output_type -> go.micro.srv.task.SystemGoResponse
	9,  // 99: go.micro.srv.task.TaskService.Debug:output_type -> go.micro.srv.task.Response
	9,  // 100: go.micro.srv.task.TaskService.DebugConfig:output_type -> go.micro.srv.task.Response
	34, // 101: go.micro.srv.task.TaskService.GetDebugConfig:output_type -> go.micro.srv.task.DebugConfigResponse
