...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	31, // 30: go.micro.srv.task.TaskFilter.phaseGT:type_name -> google.protobuf.Int32Value
	31, // 31: go.micro.srv.task.TaskFilter.phaseLT:type_name -> google.protobuf.Int32Value
	31, // 32: go.micro.srv.task.TaskFilter.phaseGE:type_name -> google.protobuf.Int32Value
	31, // 33: go.micro.srv.task.TaskFilter.phaseLE:type_name -> google.protobuf.Int32Value
	31, // 34: go.micro.srv.task.TaskFilter.originStation:type_name -> google.protobuf.Int32Value
	31, // 35: go.micro.srv.task.TaskFilter.targetStation:type_name -> google.protobuf.Int32Value
	31, // 36: go.micro.srv.task.TaskFilter.agvID:type_name -> google.protobuf.Int32Value
	31, // 37: go.micro.srv.task.TaskFilter.agvInitPoint:type_name -> google.protobuf.Int32Value
	33, // 38: go.micro.srv.task.TaskFilter.materialID:type_name -> google.protobuf.Int64Value
	11, // 39: go.micro.srv.task.TaskFilter.parameter:type_name -> go.micro.srv.task.TaskParameterFilter
	31, // 40: go.micro.srv.task.TaskFilter.errorCode:type_name -> google.protobuf.Int32Value
	32, // 41: go.micro.srv.task.TaskFilter.error:type_name -> google.protobuf.StringValue
	31, // 42: go.micro.srv.task.TaskFilter.entranceID:type_name -> google.protobuf.Int32Value
	31, // 43: go.micro.srv.task.TaskFilter.orderType:type_name -> google.protobuf.Int32Value
	31, // 44: go.micro.srv.task.TaskFilter.rackID:type_name -> google.protobuf.Int32Value
	...
	8,  // 72: go.micro.srv.task.TaskService.New:output_type -> go.micro.srv.task.Response
	8,  // 73: go.micro.srv.task.TaskService.Pause:output_type -> go.micro.srv.task.Response
	8,  // 74: go.micro.srv.task.TaskService.Cancel:output_type -> go.micro.srv.task.Response
	8,  // 75: go.micro.srv.task.TaskService.UpdateTask:output_type -> go.micro.srv.task.Response
	8,  // 76: go.micro.srv.task.TaskService.BatchNew:output_type -> go.micro.srv.task.Response
	8,  // 77: go.micro.srv.task.TaskService.BatchCancel:output_type -> go.micro.srv.task.Response
	8,  // 78: go.micro.srv.task.TaskService.SetParameters:output_type -> go.micro.srv.task.Response
	8,  // 79: go.micro.srv.task.TaskService.DeleteParameters:output_type -> go.micro.srv.task.Response
	24, // 80: go.micro.srv.task.TaskService.GetTask:output_type -> go.micro.srv.task.TaskInfo
	24, // 81: go.micro.srv.task.TaskService.GetHistoryTask:output_type -> go.micro.srv.task.TaskInfo
	25, // 82: go.micro.srv.task.TaskService.GetTasks:output_type -> go.micro.srv.task.TaskInfos
	25, // 83: go.micro.srv.task.TaskService.GetHistoryTasks:output_type -> go.micro.srv.task.TaskInfos
	27, // 84: go.micro.srv.task.TaskService.Call:output_type -> go.micro.srv.task.CallResponse
	29, // 85: go.micro.srv.task.TaskService.Execute:output_type -> go.micro.srv.task.ExecuteResponse
	8,  // 86: go.micro.srv.task.TaskService.SetGP:output_type -> go.micro.srv.task.Response
	8,  // 87: go.micro.srv.task.TaskService.DelGP:output_type -> go.micro.srv.task.Response
	4,  // 88: go.micro.srv.task.TaskService.GetGP:output_type -> go.micro.srv.task.GpParameter
	5,  // 89: go.micro.srv.task.TaskService.GetGPs:output_type -> go.micro.srv.task.GpParameters
	8,  // 90: go.micro.srv.task.TaskService.ConfigSystemGo:output_type -> go.micro.srv.task.Response
	8,  // 91: go.micro.srv.task.TaskService.RestartSystemGo:output_type -> go.micro.srv.task.Response
